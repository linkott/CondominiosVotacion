...
<title>Comedor - Colegio Universitario de Caracas</title>
...
<div id="contenido" class="bordePrincipal" style="background-image:url(css/pepper-grinder/images/ui-bg_fine-grain_15_ffffff_60x60.png);">
   ...
   <tr>
    <td id="inicio">
	   ...
	   <table id="login" align="left">
	   <tr>
	   <td>
	     Usuario: <input id="IdUsuario" name="IdUsuario" type="text" size="15">
	   </td>
       <td>	   
		 Contrase&ntilde;a: <input id="Password" name="Password" type="password" size="15">
	   </td>
       <td>	   
		 <button id="Autenticar" name="Autenticar" type="submit"> Iniciar </button>
	   </td>
       </tr>
       </table>	   
	   </form>	
   ...
   <div id="tabs">
       <ul>
          <li><a href="ProcesaPersona.php" title="Tab-Ingreso">Ingreso</a></li>
  ...
  <div id="piepagina">
       ...
       <tr>
       <td align="center"><span class="leyenda">Direcci&oacute;n: Av. Francisco de Miranda, Urb. La Floresta, Edificio Sucre. Piso 2. Altamira. Tel&eacute;fonos: 0212-2088224. e-mail: comisiondt@cuc.edu.ve</span></td>
       </tr>
       </table> 	   
	   <table class="borde" style="border-style:solid none none none;" width="100%">	   
		<tr>
		<td align="center"><span class="leyenda">Optimizada para una resoluci&oacute;n de 1024x768 - &copy; 2013 by Francisco Montilla</span></td>
	   </tr>
	   </table>	
  </div>  
</body>
