...
while ($fila=mysql_fetch_array($consulta)){
	...
	$str = $fila['cod_seccion'];
	$struni = $str[0].$str[1];

	if($struni =='13'){
		$carrera = "P.N.F. ADMINISTRACIÓN";
	}else if($struni =='14'){
		$carrera = "P.N.F. INFORMÁTICA";
	}else if($struni =='15'){
		$carrera = "P.N.F. TURISMO";
	}else{
		$carrera = "No hay";
	}
